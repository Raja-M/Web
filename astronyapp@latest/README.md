...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/4b8zeHWYOB)
...
```sh
npx nx serve astronyapp@latest
```

To create a production bundle:

```sh
npx nx build astronyapp@latest
```

To see all available targets to run for a project, run:

```sh
npx nx show project astronyapp@latest
```
