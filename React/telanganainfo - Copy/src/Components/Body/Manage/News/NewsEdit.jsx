...
import { useAddNewNewsMutation, useDeleteNewsMutation, useUpdateNewsMutation } from '../../../../App/Redux/Contents/News/NewsSlice';
...
const NewsEdit = () => {
    ...
    const [ addNewNews, { isLoading}] = useAddNewNewsMutation()
                ...
                { 
                    ...
                    >
                        <form onSubmit={handleSubmit(onSubmit)}>
                                            ...
                                            <Grid item xs={12} >
                                                {id && newsItem ? (
                                                    <article style={{ display: 'block' }}>
                                                        ...
                                                        <ReactionButton newsItem={newsItem ? newsItem : ''}> </ReactionButton>
                                                    </article>
                                                ) :
                                                    (''
                                                    )
                            ...
                            <Grid item xs={12} >
                                <input disabled={!isValid && isLoading } type="submit" />
